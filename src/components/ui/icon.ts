export const Icons = {
  ...
  tiktok: {
    paths: [
      {
        d: "M16.932 2.118c.597 3.31 2.782 4.914 5.063 5.107v4.251c-1.275.126-2.482-.04-3.648-.52v6.283c0 5.292-5.764 9.491-11.627 7.038-1.607-.674-2.882-1.977-3.662-3.642-1.93-4.068.08-8.575 4.033-9.79.504-.161 1.026-.252 1.557-.274v4.331c-.491.102-.978.243-1.457.422-1.935.711-3.02 2.681-2.617 4.602.309 1.457 1.334 2.632 2.676 3.19 3.12 1.299 6.945-.923 6.945-4.235V5.508c1.4.984 2.993 1.632 4.807 1.557V2.118h-2.07Z",
      },
    ],
    class: "size-4 flex-shrink-0 fill-current",
    viewBox: "0 0 24 24",
